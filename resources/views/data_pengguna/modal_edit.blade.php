    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <form action="{{ route('data_pengguna.update', $dt->id) }}" method="post">
                    @csrf @method('PUT')
                ...
                <div class="pd-30 pd-sm-40 bg-gray-100">
                    <div class="row row-xs align-items-center mg-b-20">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->username }}" placeholder="Enter your Username" name="username" value="{{ old('username') }}" type="text">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->email }}"  placeholder="Enter your Email" name="email" value="{{ old('email') }}" type="email">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->password }}"  placeholder="Enter your Password" type="text" name="password" value="{{ old('password') }}">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->nama_lengkap }}" placeholder="Enter your Nama Lengkap" type="text" name="nama_lengkap" value="{{ old('nama_lengkap') }}">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                            <input class="form-control" value="{{ $dt->alamat }}" placeholder="Enter your Alamat" type="text" name="alamat" value="{{ old('alamat') }}">
                        </div>
                    </div>
                    <div class="row row-xs align-items-center mg-b-20">
                        <div class="col-md-4">
