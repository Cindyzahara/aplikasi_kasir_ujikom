                ...
                <div class="main-header-right">
                    ...
                    <div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
                        ...
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            ...
                            <a class="profile-user d-flex" href=""><img src="{{ asset('assets') }}/img/faces/logoapk.png" alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>

                            <div class="dropdown-menu">
                                <div class="main-header-profile header-img">
                                    <div class="main-img-user"><img alt="" src="{{ asset('assets') }}/img/faces/cindy.jpg"></div>
