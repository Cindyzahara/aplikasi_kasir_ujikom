    ...
    <div class="main-signin-wrapper">
        ...
        <div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
            <div class="my-auto authentication-pages">
                <div>
                    <img src="{{ asset('assets') }}/img/brand/logolog.png" class=" m-0 mb-5" alt="logo">
                    <h5 class="mb-4">Harap Login terlebih dahulu untuk masuk ke aplikasi</h5>
                    <p class="mb-5">Selamat Datang Pengguna !!</p>
                </div>
            </div>
        </div>
        <div class="sign-up-body wd-md-50p">
            ...
            <div class="main-signin-footer mt-3 mg-t-5">
                ...
                <p>Don't have an account? <a href="{{ route('registrasi') }}">Register</a></p>
                {{-- @endif --}}
            </div>
        </div>
    </div>
