            ...
            <div class="card">
                <div class="card-header" >
                    ...
                    <div class="d-flex my-auto btn-list justify-content-end">            
                        ...
                        <a href="{{ route('export_pdf_penjualan') }}" class="btn btn-danger"><i class="fa fa-download me-2"></i>Export PDF</a>
...
@include('penjualan.modal_create')
@endsection